...
server_config = {
    "server_id": "server2",
    "next_node_url": "http://localhost:5003/receive",  # Forward to server3
    "key_file_path": "../server2/aes_key2.bin",  # Key for this server
}
...
if __name__ == "__main__":
    app.run(host='0.0.0.0', port=5002)  # Server2 on port 5002
